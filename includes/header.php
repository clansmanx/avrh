...
<li><hr class="dropdown-divider"></li>
<li>
    <a class="dropdown-item" href="<?php echo SITE_URL; ?>/modules/relatorios/individual.php">
        <i class="bi bi-grid-3x3-gap-fill"></i> Individual
    </a>
</li>

<li><hr class="dropdown-divider"></li>
<li>
    <a class="dropdown-item" href="<?php echo SITE_URL; ?>/modules/relatorios/matriz_9box.php">
        <i class="bi bi-grid-3x3-gap-fill"></i> Matriz 9-Box Estratégica
    </a>
</li>
