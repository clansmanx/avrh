...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['adicionar'])) {
        ...
        if (empty($erros)) {
            ...
            $nivel = $_POST['nivel'] ? $functions->validarEFormatarInput($_POST['nivel'], 'nome') : null;
                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php echo isset($erros['nome']) ? 'is-invalid' : ''; ?>" 
                               ...
                               maxlength="100"
                               value="<?php echo htmlspecialchars($editar['nome'] ?? $dados['nome'] ?? ''); ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="nivel">
                            ...
                            <option value="<?php echo $n; ?>" 
                                <?php echo (($editar && $editar['nivel'] == $n) || ($dados['nivel'] ?? '') == $n) ? 'selected' : ''; ?>>
                                <?php echo $n; ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="descricao" rows="3" maxlength="255"><?php 
                            echo htmlspecialchars($editar['descricao'] ?? $dados['descricao'] ?? ''); 
                        ?></textarea>
                        <?php if (isset($erros['descricao'])): ?>
                            <div class="invalid-feedback d-block">
                                <?php echo implode(', ', $erros['descricao']); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" name="ativo" id="ativo" 
                               <?php echo ($editar['ativo'] ?? 1) ? 'checked' : ''; ?>>
