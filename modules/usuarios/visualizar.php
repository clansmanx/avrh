<?php
// modules/usuarios/visualizar.php
            ...
            <div class="col-md-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Gráfico de evolução - SOMENTE SE TIVER PELO MENOS 2 AVALIAÇÕES CONCLUÍDAS -->
                        <?php 
                        $avaliacoes_concluidas = array_filter($avaliacoes, function($a) {
                            return !empty($a['nota_final']);
                        });
                        
                        if (count($avaliacoes_concluidas) >= 2): 
                        ?>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            // Preparar dados apenas das avaliações concluídas
                            const avaliacoes = <?php 
                                $dados_grafico = array_reverse(array_values($avaliacoes_concluidas));
                                echo json_encode([
                                    'labels' => array_column($dados_grafico, 'ciclo_nome'),
                                    'notas' => array_column($dados_grafico, 'nota_final')
                                ]); 
                            ?>;
                ...
                <!-- Competências mais avaliadas -->
                <div class="card">
                    <div class="card-header">
                        <h5>Competências Destacadas</h5>
                    </div>
                    <div class="card-body">
                        <?php
                            ...
                            <div class="mb-3">
                                <div class="d-flex justify-content-between">
                                    <span>
                                        ...
                                        <small class="text-muted">(<?php echo $comp['total_avaliacoes']; ?> avaliações)</small>
                                    </span>
