                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nome" name="nome" 
                                                   value="<?php echo htmlspecialchars($_POST['nome'] ?? $usuario['nome']); ?>" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" name="empresa_id" id="empresa_id" required>
                                                ...
                                                <option value="<?php echo $emp['id']; ?>" 
                                                    <?php echo ($_POST['empresa_id'] ?? $usuario['empresa_id']) == $emp['id'] ? 'selected' : ''; ?>>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" id="gestor_id" name="gestor_id">
                                                ...
                                                <option value="<?php echo $gestor['id']; ?>"
                                                    <?php echo ($_POST['gestor_id'] ?? $usuario['gestor_id']) == $gestor['id'] ? 'selected' : ''; ?>>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" class="form-control" id="data_contratacao" name="data_contratacao" 
                                                   value="<?php echo $_POST['data_contratacao'] ?? $usuario['data_contratacao']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" id="tipo" name="tipo" required>
                                                <option value="colaborador" <?php echo ($_POST['tipo'] ?? $usuario['tipo']) == 'colaborador' ? 'selected' : ''; ?>>Colaborador</option>
                                                <option value="gestor" <?php echo ($_POST['tipo'] ?? $usuario['tipo']) == 'gestor' ? 'selected' : ''; ?>>Gestor</option>
                                                <option value="rh" <?php echo ($_POST['tipo'] ?? $usuario['tipo']) == 'rh' ? 'selected' : ''; ?>>RH</option>
                                                <option value="admin" <?php echo ($_POST['tipo'] ?? $usuario['tipo']) == 'admin' ? 'selected' : ''; ?>>Administrador</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-check mt-4">
                                                <input type="checkbox" class="form-check-input" id="ativo" name="ativo" value="1"
                                                       <?php echo ($_POST['ativo'] ?? $usuario['ativo']) ? 'checked' : ''; ?>>
